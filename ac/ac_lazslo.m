...
% Equations Using the Artificial Compressibility
% Formulation of Chorin, 1967

% Written by Dr. Laszlo Konozsy ' 28. 01. 2025
...
%===================================================================%
% 1. SOLUTION OF THE PERTURBED CONTINUITY EQUATION FOR THE PRESSURE %
%===================================================================%
 ...
 for j = 2:(jmax-1)
  for i = 2:(imax-1)
   ...
   % ESTIMATE THE PRESSURE FIELD VALUES IN THE INTERNAL DOMAIN
   p(i,j) = pn(i,j)-betaAC*delta_tau*(dundx+dvndy);
  end 
 end 
...
%==================================================================%
% 2. SOLUTION OF THE NAVIER-STOKES SCALAR MOMENTUM EQUATIONS (U,V) %
%==================================================================%
 ...
 for j = 2:(jmax-1)
  for i = 2:(imax-1)
   ...
   u(i,j) = un(i,j)+delta_tau*(gx-dpdx/rho+nu*LaplacianU-un(i,j)*dundx-vn(i,j)*dundy);
   v(i,j) = vn(i,j)+delta_tau*(gy-dpdy/rho+nu*LaplacianV-un(i,j)*dvndx-vn(i,j)*dvndy);
  end 
 end 
 ...
 clc;
 disp('Navier-Stokes Solver with the AC Method of Chorin in a 2D Channel (Written by Dr. Laszlo Konozsy):');
 sumU
 sumV
 sumP
